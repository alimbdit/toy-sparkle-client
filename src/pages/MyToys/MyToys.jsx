    ...
    <div className="bg-rose-100 bg-opacity-25 pb-16">
      ...
      <div className="bg-neutral-200 mx-1 lg:mx-5 rounded-md my-5 py-10  px-2 lg:px-10">
        <div className="btn-group mb-2">
         <button onClick={() => handleSort("ascending")} className={`rounded-s ${sort == "ascending"?"btn-sort" :"btn-sort-hover "}`}>Ascending</button>
         <button onClick={() => handleSort("descending")} className={`rounded-e ${sort == "descending"?"btn-sort" :"btn-sort-hover "}`}>Descending</button>
